...
export function Model(props) {
  const { nodes, materials } = useGLTF('/carved_wooden_plate_4k-transformed.glb')
  return (
    <group {...props} dispose={null}>
      <mesh geometry={nodes.carved_wooden_plate.geometry} material={materials.carved_wooden_plate} />
    </group>
  )
}
