...
export function Model(props) {
  const { nodes, materials } = useGLTF('/book_encyclopedia_set_01_4k-transformed.glb')
  return (
    <group {...props} dispose={null}>
      <group position={[0, 0, 0.101]}>
        <mesh geometry={nodes.Cube004.geometry} material={materials.book_encyclopedia_set_01_cover} />
        <mesh geometry={nodes.Cube004_1.geometry} material={materials.book_encyclopedia_set_01_paper} />
      </group>
    </group>
  )
}
